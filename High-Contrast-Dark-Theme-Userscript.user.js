...
const css = `
  ...
  * {
  ...
  .character-wrap .header .name,
  .staff-wrap .header .name {
    color: rgb(var(--color-gray-900));
  }
  .character-wrap .header .name-alt,
  .staff-wrap .header .name-alt {
    color: rgb(var(--color-gray-800));
  }
  .character-wrap .header .edit,
  .staff-wrap .header .edit {
    color: rgb(var(--color-gray-800));
  }
  /* ------ Database Tools ------ */
  .media.container {
